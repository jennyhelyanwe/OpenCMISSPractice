...
GeometricFieldExport(region, "cellML3_undeformed")

# Set up material field
params = [24.82, 0.37, 6.35, 6.94, 11.32, 11.67, 0.22, 7.07, 1.0, 1.0]
...
DependentFieldInitialise(dependentField, geometricField, -10.0)

# Set up CellML constitutive model linkage
cellMLfilename = "holzapfel_2009.cml"
parameter_names = ["af", "afs", "an", "as", "bf", "bfs", "bn", "bs"]
