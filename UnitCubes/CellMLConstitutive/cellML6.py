...
GeometricFieldExport(region, "cellML6_undeformed")

# Set up material field
params = [0.413039, 8.706459, 20.572067, 11.832540, 2.631297, 5.020398, 0.361115, 11.824441]
...
DependentFieldInitialise(dependentField, geometricField, -0.2065195)

# Set up CellML constitutive model linkage
cellMLfilename = "holzapfel_ogden.cellml"
parameter_names = ["a", "b", "a_f",  "b_f", "a_s", "b_s", "a_fs",  "b_fs", ]
...
elementNumbers = [1]
gaussPoints = [1,8,64]
ExportStressStrain(elementNumbers,gaussPoints, equationsSet, 'cellML1_strain.exdata', 'cellML1_stress.exdata',
