...
GeometricFieldExport(region, "cellML5_undeformed")

# Set up material field
params = [1.0, 5.0, 10.0, 0.0, 5.0, 20]
...
cellMLfilename = "transversely_isotropic_exponential_active.cellml"
parameter_names = ["C1", "C2", "C3", "C4", "C5", "TCa"]
